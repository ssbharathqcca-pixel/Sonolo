...
Status: living document. Scope changes go through [DECISION_LOG.md](DECISION_LOG.md) first, then this file is updated to match.
...
2. Canadian English and Canadian French.
...
| Realtime | WebSockets |
| AI | Open-source models (specific models TBD — see [DECISION_LOG.md](DECISION_LOG.md)) |
| Payments | RevenueCat |
| Analytics | PostHog |
...
Each resolves through a DECISION_LOG entry before related tasks go to Spec Ready.
