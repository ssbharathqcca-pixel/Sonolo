...
DEFAULT_SOURCE = REPO_ROOT / "content" / "generated" / "finance-english-v1.md"
SCENARIOS_OUT = REPO_ROOT / "content" / "scenarios" / "finance-english-v1.json"
VOCAB_OUT = REPO_ROOT / "content" / "vocabulary" / "finance-english-v1.json"
def clean_obj(obj):
