...
DEFAULT_SOURCE = REPO_ROOT / "content" / "generated" / "workplace-english-v1.md"
SCENARIOS_OUT = REPO_ROOT / "content" / "scenarios" / "workplace-english-v1.json"
VOCAB_OUT = REPO_ROOT / "content" / "vocabulary" / "workplace-english-v1.json"
...
def main():
    ...
    # Fix AI markdown escape artifacts (\_ -> _, \- -> -, etc.)
    ...
    # Strip trailing spaces from keys AND values (critical for DB UUIDs)
    data = clean_obj(data)
